# IUserApiClient.DeleteDatabaseAccessLevelAsync Method 
...
**VB**<br />
``` VB
Function DeleteDatabaseAccessLevelAsync ( 
	username As String,
	dbName As String
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.threading.tasks.task-1" target="_blank" rel="noopener noreferrer">Task</a>(<a href="68062b0c-edbd-c1a6-36d1-03c0dc0bd80f">DeleteAccessLevelResponse</a>)<br />\[Missing <returns> documentation for "M:ArangoDBNetStandard.UserApi.IUserApiClient.DeleteDatabaseAccessLevelAsync(System.String,System.String)"\]
