# PostTransactionResponse(*T*) Class
...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;ArangoDBNetStandard.TransactionApi.Models.PostTransactionResponse(T)<br />
...
**VB**<br />
``` VB
Public Class PostTransactionResponse(Of T)
```

**C++**<br />
``` C++
generic<typename T>
public ref class PostTransactionResponse
```

**F#**<br />
``` F#
type PostTransactionResponse<'T> =  class end
```


#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>Type used to deserialize the returned object from the transaction function.</dd></dl>&nbsp;
The PostTransactionResponse(T) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="a912f7ad-0931-cbfc-2faf-f2a5d3a07384">PostTransactionResponse(T)</a></td><td>
Initializes a new instance of the PostTransactionResponse(T) class</td></tr></table>&nbsp;
<a href="#posttransactionresponse(*t*)-class">Back to Top</a>
