...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;ArangoDBNetStandard.GraphApi.Models.PostEdgeDefinitionBody<br />
...
**C++**<br />
``` C++
public ref class PostEdgeDefinitionBody
```

**F#**<br />
``` F#
type PostEdgeDefinitionBody =  class end
```

The PostEdgeDefinitionBody type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="1bdd3fbe-6eca-4c42-115b-8ba3257ac295">PostEdgeDefinitionBody</a></td><td>
Initializes a new instance of the PostEdgeDefinitionBody class</td></tr></table>&nbsp;
<a href="#postedgedefinitionbody-class">Back to Top</a>
