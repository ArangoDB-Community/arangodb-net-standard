...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;<a href="1e4d73ca-864e-e82d-2705-3f6909ffa824">ArangoDBNetStandard.ApiClientBase</a><br />&nbsp;&nbsp;&nbsp;&nbsp;ArangoDBNetStandard.DocumentApi.DocumentApiClient<br />
...
Public Class DocumentApiClient
	...
	Implements IDocumentApiClient
```

**C++**<br />
``` C++
public ref class DocumentApiClient : public ApiClientBase, 
	IDocumentApiClient
```
...
Creates an instance of DocumentApiClient using the provided transport layer and the default JSON serialization.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="3e469d86-2e9e-107a-5461-791e72bf14ce">DocumentApiClient(IApiClientTransport, IApiClientSerialization)</a></td><td>
Creates an instance of DocumentApiClient using the provided transport and serialization layers.</td></tr></table>&nbsp;
<a href="#documentapiclient-class">Back to Top</a>
