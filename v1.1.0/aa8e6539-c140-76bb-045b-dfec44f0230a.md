...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;ArangoDBNetStandard.GraphApi.Models.PostEdgeQuery<br />
...
**C++**<br />
``` C++
public ref class PostEdgeQuery
```

**F#**<br />
``` F#
type PostEdgeQuery =  class end
```

The PostEdgeQuery type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="7bae140f-cf3f-5515-6252-8fa5bbb7f109">PostEdgeQuery</a></td><td>
Initializes a new instance of the PostEdgeQuery class</td></tr></table>&nbsp;
<a href="#postedgequery-class">Back to Top</a>
